...
void setup() {
  ...
  //stepper1.moveTo(1000);// its a compleate round
...
void loop() {
  ...
  if (stateBUP == HIGH && counter <= 7000 && stateBDOWN == LOW) {
  ...
  if (stateBUP == LOW && stateBDOWN == LOW) {
  ...
  if (stateBDOWN == HIGH && counter > 0 && stateBUP == LOW) {
